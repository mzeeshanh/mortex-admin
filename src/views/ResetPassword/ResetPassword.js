  ...
  return (
    <>
      <div
        ...
        data-color="black"
        data-image={"https://res.cloudinary.com/arhamsoft-ltd/image/upload/v1655727483/hex-nft/assets/bg-banner-img_gpjreo.png"}
      >
        ...
        <div
          ...
          style={{ backgroundImage: "url(https://res.cloudinary.com/arhamsoft-ltd/image/upload/v1655727483/hex-nft/assets/bg-banner-img_gpjreo.png)" }}
        ></div>
      </div>
    </>
  );
