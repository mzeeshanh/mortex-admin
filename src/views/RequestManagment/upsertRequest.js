...
import { addContent, beforeContent, getContent, updateContent } from './request.action';
                                                    ...
                                                    <div className='d-flex pt-3'>
                                                        ...
                                                        <label className='mr-3 pt-1'>
                                                            ...
                                                            <label class="right-label-checkbox">&nbsp;
                                                                <input type="checkbox" checked={data.showInFooter} onChange={(e) => { setData({ ...data, showInFooter: !data.showInFooter }); }} />
...
export default connect(mapStateToProps, { addContent, beforeContent, getContent, updateContent })(UpsertContent);